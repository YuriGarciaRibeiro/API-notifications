...
**Serialização JSON com discriminador:**
```json
{
  "id": "abc-123",
  "userId": "user-456",
...
// ❌ Errado - Lazy loading não está habilitado
...
// ❌ Errado - Expõe entidade de domínio
return notification;
```
...
// ❌ Menos eficiente - Carrega tudo e filtra em memória
